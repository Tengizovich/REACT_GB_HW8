import logoSite from '../icon/logoSite.png'
import iconBasketQuantity from '../icon/iconBasketQuantity.svg'
import { Link } from 'react-router-dom';

function Header() {
    return (
        <header class="styleHeader">
            <nav class="headNav centering">
                <div class="headNav_left">
                    <Link to="/" >
                        <img src={logoSite} alt="logo Site" />
                    </Link>
                    <Link to='/Catalog' class="hoverIcon">
                ...
                <div class="headNav_right">
                    <details class="BoorgerMenu">
                        <summary class="BoorgerMenu-summary">
                        ...
                        <div class="menu">
                            ...
                            <div class="menu-option">
                                <Link class="menu-option" to="/Catalog">
                                    MAN
                                    <div class="menu-option-elem">
                                        <p class="menu-option-elem-text">
                                            Accessories</p>
                                        <p class="menu-option-elem-text">
                                            Bags</p>
                                        <p class="menu-option-elem-text">
                            ...
                            <div class="menu-option">
                                <Link class="menu-option" to="/Product">
                                    WOMAN
                                    <div class="menu-option-elem">
                                        <p class="menu-option-elem-text">
                                            Accessories</p>
                    ...
                    <Link to="/Registration" class="headNav_right_hoverIcon">
                    ...
                    <div class="headNav_right_basket_box">
                        <Link to='/Cart' class="hoverIcon">
                        ...
                        <img src={iconBasketQuantity} alt="icon Basket Quantity" class="headNav_right_basket_num" />
                    </div>
                </div>
            </nav >
        </header >
